  ...
  return (
    <div className="fixed bottom-20 lg:bottom-8 right-5 z-40 select-none">
      ...
      <button
        ...
        className="w-14 h-14 rounded-full bg-emerald-600 hover:bg-emerald-500 text-white flex items-center justify-center shadow-xl hover:scale-110 active:scale-95 transition-all cursor-pointer relative group"
